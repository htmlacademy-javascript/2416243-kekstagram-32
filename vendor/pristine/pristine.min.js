  ...
  function f(t, s, u) {
    ...
    function p(t) {
      for (var n = [], i = !0, s = 0; t.validators[s]; s++) {
        ...
        if (l[0] = t.input.value, !a.fn.apply(t.input, l) && (i = !1, 'function' == typeof a.msg ? n.push(a.msg(t.input.value, l)) : 'string' == typeof a.msg ? n.push(r.apply(a.msg, l)) : a.msg === Object(a.msg) && a.msg[o] ? n.push(r.apply(a.msg[o], l)) : t.messages[o] && t.messages[o][a.name] ? n.push(r.apply(t.messages[o][a.name], l)) : e[o] && e[o][a.name] && n.push(r.apply(e[o][a.name], l)), !0 === a.halt)) {
          break;
        }
      }
      return t.errors = n, i;
